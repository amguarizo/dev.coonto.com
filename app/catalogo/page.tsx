      ...
      <div className="content">
        ...
        <section className="catalog-grid" aria-label="Três obras do catálogo inicial">
          <article className="book-card featured">
            ...
            <div><span className="tag">DISPONÍVEL · SEMPRE GRÁTIS</span><h2>O Alienista</h2><span className="author">Machado de Assis</span><p>Entre em Itaguaí, tome decisões, descubra as consequências e encontre o caminho do autor.</p></div>
            <div><a href="/leitura/o-alienista" className="button button-light">Acessar gratuitamente <ArrowRight size={18}/></a><p><a href="/texto/o-alienista" style={{color:"inherit",textDecoration:"underline"}}>Ler o texto original de Machado</a></p></div>
          </article>
        ...
        <section className="catalog-offer" aria-labelledby="catalog-offer-title">
          ...
          <div className="offer-grid">
            <article className="price-card"><h3>Obra individual</h3><p>Acesso a uma experiência Coonto disponível.</p><span className="old-price" aria-label={`Preço de referência, riscado: ${singlePrice}`}>{singlePrice}</span><span className="free-price">GRÁTIS</span><span className="limited">O Alienista é a obra gratuita permanente</span><a className="button button-primary" href="/leitura/o-alienista"><BookOpen size={18}/>Acessar gratuitamente</a><p className="access-note"><Download size={15}/> Depois de entrar, você pode salvar <em>O Alienista</em> no aparelho para leitura offline autorizada. Não é um arquivo público para baixar.</p></article>
            <article className="price-card club"><h3>Coonto Club</h3><p>Catálogo e novas edições mensais, após o lançamento com três obras prontas.</p><span className="old-price" aria-label={`Preço de referência, riscado: ${clubPrice} por mês`}>{clubPrice}/mês</span><span className="free-price">AINDA NÃO DISPONÍVEL</span><span className="limited">Experimente a obra gratuita agora</span><a className="button button-coral" href="/leitura/o-alienista">Explorar sem pagar</a><p className="access-note">O Club ainda não aceita assinaturas. Não haverá cobrança automática por este acesso gratuito.</p></article>
          </div>
        </section>
